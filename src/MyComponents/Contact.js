...
//       <h2 class="text-black text-2xl text-center mb-1 font-bold title-font">Contact Us</h2>
...
//       </div>
//       <div class="relative mb-1">
//         <label for="message" class="leading-7 text-center text-sm text-black">Message</label>
