              ...
              <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="flex space-x-4">
                      {navigation.map((item) => (
                        <a
                          ...
                          onMouseOver={() => speak({ text: item.name })}
                        >
                          {item.name}
                        </a>
                      ))}
                ...
                >
                  ...
                  <label className="swap swap-rotate">
                    ...
                    {/* Light */}
                    <svg
                      className="w-10 h-10 fill-current swap-on invert"
                    ...
                    {/* Dark */}
                    <svg
                      className="w-10 h-10 fill-current swap-off invert dark"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                        ...
                        <Menu.Item>
                          {({ active }) => (
                            <a
                              ...
                              onMouseOver={() => speak({ text: settings })}
                            >
                              Settings
                            </a>
                          )}
